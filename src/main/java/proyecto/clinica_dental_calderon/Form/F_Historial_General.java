...
public class F_Historial_General extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnLimpiarFiltros.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        btnLimpiarFiltros.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnLimpiarFiltrosActionPerformed(evt);
            }
        });
        jPanel1.add(btnLimpiarFiltros, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 20, 150, 40));
        ...
        btnAplicarFiltros.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        btnAplicarFiltros.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAplicarFiltrosActionPerformed(evt);
            }
        });
        jPanel1.add(btnAplicarFiltros, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 20, 150, 40));
    ...
    private void btnAplicarFiltrosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAplicarFiltrosActionPerformed
        ...
        String columnaMetodoPago = "Método de Pago"; // Nombre de la columna donde se encuentra el método de pago
        ...
        RowFilter<Object, Object> rowFilter = RowFilter.regexFilter(metodoSeleccionado, 8); // Filtrar por columna 8 (columna del método de pago)

        if (metodoSeleccionado.equals("Todos")) {
            sorter.setRowFilter(null); // Mostrar todos los registros si se selecciona "Todos"
        } else {
            sorter.setRowFilter(rowFilter); // Aplicar filtro según el método de pago seleccionado
        }
